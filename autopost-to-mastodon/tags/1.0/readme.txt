...
= Mastodon PHP API =
This project is using a modified Mastodon PHP libary based on the work of [yks118](https://github.com/yks118/Mastodon-api-php)
...
*	[Wikipedia](https://commons.wikimedia.org/wiki/File:GNU-social-logo.svg) - Mastodon logo used in the logo (CC0)
